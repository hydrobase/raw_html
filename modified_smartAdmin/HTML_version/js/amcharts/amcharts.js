    ...
    d.AxisBase = d.Class({
        construct: function (a) {
            ...
            this.periods = [{period: "ss", count: 1}, {period: "ss", count: 5},
                {period: "ss", count: 10}, {period: "ss", count: 30}, {period: "mm", count: 1}, {
                    ...
                    period: "MM",
                    count: 6
                }, {period: "YYYY", count: 1}, {period: "YYYY", count: 2}, {
                    period: "YYYY",
                    count: 5
        ...
        pushAxisItem: function (a, b) {
            ...
            for (var b = this.guides,
                     c = !1, e = b.length, h = 0; h < b.length; h++)b[h] == a && (c = !0, e = h);
        ...
        addEventListeners: function (a, b) {
            ...
            for (var b =
                10; 0 < b; b--)if (a / b == Math.round(a / b))return a / b
            ...
            var u, x = this.gridAlpha, y, w = this.choosePeriod(0), z = w.period, w = w.count, A = d.getPeriodDuration(z, w);
            A < k && (z = g.period, w = g.count, A = k);
            g = z;
            "WW" == g && (g = "DD");
            this.stepWidth = this.getStepWidth(this.timeDifference);
            var B = Math.ceil(this.timeDifference / A) + 5, C = l = d.resetDateToMin(new Date(this.startTime - A), z, w, t).getTime();
            ...
            if (0 < this.gridCountR)for (B - 5 - k >
                                         this.autoRotateCount && !isNaN(this.autoRotateAngle) && (this.labelRotationR = this.autoRotateAngle), a = k; a <= B; a++) {
                ...
                this.pushAxisItem(m);
                m = l = p;
                if (!isNaN(u))for (h = 1; h < w; h += u)this.gridAlpha = this.minorGridAlpha, f = p + y * h, f = d.resetDateToMin(new Date(f), z, u, t).getTime(), f = new this.axisItemRenderer(this, (f - this.startTime) * this.stepWidth, void 0, void 0, void 0, void 0, void 0, void 0, void 0, !0), this.pushAxisItem(f);
                this.gridAlpha = x
            }
        }, choosePeriod: function (a) {
            var b = d.getPeriodDuration(this.periods[a].period, this.periods[a].count), c = this.periods;
            return this.timeDifference <
            b && 0 < a ? c[a - 1] : Math.ceil(this.timeDifference / b) <= this.gridCountR ? c[a] : a + 1 < c.length ? this.choosePeriod(a + 1) : c[a]
...
(function () {
    ...
    d.ValueAxis = d.Class({
        inherits: d.AxisBase, construct: function (a) {
            ...
            if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max)e = !0; else {
                ...
                if (this.autoGridCount || 0 !== this.gridCount)if ("date" == c)this.generateDFObject(), this.timeDifference = this.max - this.min, this.maxTime = this.lastTime =
                    ...
                    if (c == this.baseValue && "radar" != a.type) {
                        ...
                        B && (t = d.fitToBounds(2 * this.gridAlpha, 0, 1), isNaN(this.zeroGridAlpha) || (t = this.zeroGridAlpha), t = d.line(a.container, B, C, this.gridColor, t, 1, this.dashLength), t.translate(this.x,
                            this.y), this.grid0 = t, a.axesSet.push(t), t.toBack(), d.setCN(a, t, this.bcn + "zero-grid-" + this.id), d.setCN(a, t, this.bcn + "zero-grid"))
                    }
                    if (!isNaN(z) && 0 < w && g < r - 1) {
                        ...
                        for (D = 1; D < t; D++) {
                            var L = this.getCoordinate(c + z * D), L = new this.axisItemRenderer(this, L, "", !1, 0, 0, !1, !1, 0, !0);
                            this.pushAxisItem(L)
                        }
                        this.gridAlpha = f
                    }
                ...
                if (0 <
                    A) {
                    B = this.fillAlpha;
                    for (g = this.fillAlpha = 0; g < A; g++)C = u[g], k = NaN, z = C.above, isNaN(C.toValue) || (k = this.getCoordinate(C.toValue), t = new this.axisItemRenderer(this, k, "", !0, NaN, NaN, C), this.pushAxisItem(t, z)), l = NaN, isNaN(C.value) || (l = this.getCoordinate(C.value), t = new this.axisItemRenderer(this, l, C.label, !0, NaN, (k - l) / 2, C), this.pushAxisItem(t, z)), isNaN(k) && (l -= 3, k = l + 3), isNaN(k - l) || 0 > l && 0 > k || (k = new this.guideFillRenderer(this, l, k, C), this.pushAxisItem(k, z), z = k.graphics(), C.graphics = z, C.balloonText && this.addEventListeners(z,
                        C));
                    this.fillAlpha = B
                }
                g = this.baseValue;
            ...
            if (f)return !0 === this.logarithmic && (e = -1 != String(a).indexOf("e") ? !0 : !1), this.useScientificNotation && (e = !0), this.usePrefixes && (e = !1), e ? (c = -1 == String(a).indexOf("e") ? a.toExponential(15) : String(a), e = c.split("e"), c = Number(e[0]), e = Number(e[1]), c = d.roundTo(c, 14), 10 == c && (c = 1, e += 1), c = c + "e" + e, 0 === a && (c = "0"), 1 == a && (c = "1")) : (h && (e = String(a).split("."), e[1] ? (f.precision = e[1].length, 0 > c && (f.precision = Math.abs(c)), b && 1 < a && (f.precision =
                0)) : f.precision = -1), c = this.usePrefixes ? d.addPrefix(a, g.prefixesOfBigNumbers, g.prefixesOfSmallNumbers, f, !b) : d.formatNumber(a, f, f.precision)), this.duration && (b && (f.precision = 0), c = d.formatDuration(a, this.duration, "", this.durationUnits, this.maxInterval, f)), "date" == this.type && (c = d.formatDate(new Date(a), this.currentDateFormat, g)), this.recalculateToPercents ? c += "%" : (b = this.unit) && (c = "left" == this.unitPosition ? b + c : c + b), this.labelFunction && (c = "date" == this.type ? this.labelFunction(c, new Date(a), this).toString() :
                this.labelFunction(a, c, this).toString()), c
            ...
            this.stackType = b;
            var c =
                [], e = [], h = [], f = [], g, k = this.chart.graphs, l, m, n, q, p, t = this.baseValue, r = !1;
            ...
            for (p = n; p <= l; p++) {
                ...
                else if (m = n.type, n.chart == this.chart && n.valueAxis == this && a == m && n.stackable)if (m = this.data[p].axes[this.id].graphs[n.id], g = m.values.value, isNaN(g))n.newStack && (h[p] = NaN, e[p] = NaN); else {
...
(function () {
    ...
    d.RecItem = d.Class({
        construct: function (a, b, c, e, h, f, g, k, l, m, n, q) {
            ...
            void 0 == u && (u = p.color);
            void 0 !== n && (u = n);
            var x = a.chart.container, y = x.set();
            this.set = y;
            var w = a.axisThickness, z = a.axisColor, A = a.axisAlpha, B = a.tickLength, C = a.gridAlpha, D = a.gridThickness, L = a.gridColor, I = a.dashLength, S = a.fillColor, O = a.fillAlpha, Q = a.labelsEnabled;
            n = a.labelRotationR;
            var ia = a.counter, H = a.inside, Z = a.labelOffset, va = a.dx, ma = a.dy, Oa = a.orientation, ea = a.position, ca = a.previousCoord, X = a.height, ya = a.width, da = a.offset, fa, za;
            g ? (void 0 !== g.id && (q = p.classNamePrefix + "-guide-" + g.id), Q = !0, isNaN(g.tickLength) || (B = g.tickLength), void 0 != g.lineColor && (L = g.lineColor), void 0 != g.color && (u = g.color), isNaN(g.lineAlpha) || (C = g.lineAlpha), isNaN(g.dashLength) || (I = g.dashLength), isNaN(g.lineThickness) || (D = g.lineThickness), !0 === g.inside && (H = !0, 0 < da && (da = 0)), isNaN(g.labelRotation) ||
            ...
            if ("H" == Oa) {
                ...
                v += r / 2;
                "right" == ea ? (G +=
                    va + ya + da, v += ma, H ? (f || (v -= r / 2 + 3), G = G - (B + 4) - Z) : (G += B + 4 + w, v -= 2, G += Z)) : H ? (G += B + 4 - da, f || (v -= r / 2 + 3), g && (G += va, v += ma), G += Z) : (G += -B - w - 4 - 2 - da, v -= 2, G -= Z);
    ...
    d.AmChart = d.Class({
        construct: function (a) {
            ...
            if (b.container && !1 !== a.enabled) {
                ...
                "left" == h && (h = "start");
                "right" == h && (h = "end");
                "center" == h && (h = "middle", k ? c = b.realHeight - c + c / 2 : n = b.realWidth /
                    2 - n);
                void 0 === l && (l = 1);
                void 0 === k && (k = 0);
                c += f / 2;
            ...
            -.5 < this.tmx && this.tmx < this.divRealWidth + 1 && 0 < this.tmy && this.tmy < this.divRealHeight ? (this.handleMouseMove(),
                4 > Math.abs(this.mouseX - this.tmx) && 4 > Math.abs(this.mouseY - this.tmy) ? (this.tapped = !0, this.panRequired && this.panEventsEnabled && this.chartDiv && (this.chartDiv.style.msTouchAction = "none", this.chartDiv.style.touchAction = "none")) : this.mouseIsOver || this.resetTouchStyle()) : (this.tapped = !1, this.resetTouchStyle())
            ...
            var c = this.legend;
            c && c.position != this.prevLegendPosition && (this.previousWidth = this.mw = 0, c.invalidateSize && (c.invalidateSize(),
                this.validateSize()));
            this.write(this.div)
        }, showItem: function (a) {
            a.hidden = !1;
        ...
        construct: function (a) {
            ...
            for (m = this.start; m <= this.end; m++) {
                ...
                if (isNaN(q))this.connect || (this.drawLineGraph(b, c, e, d), b = [], c = [], e = [], d = []); else {
                    ...
                    c.push(t);
                    if (!isNaN(p)) {
                        var u = this.valueAxis.getCoordinate(p, this.noRounding) - this.height, u = u * this.valueAxis.rMultiplier, x = u * Math.sin(r / 180 * Math.PI), r = u * Math.cos(r / 180 * Math.PI);
                        e.push(x);
                        d.push(r);
                        isNaN(k) && (k = x);
                        isNaN(l) && (l = r)
            ...
            if (e) {
                var f = this.chart, g = this.valueAxis, k = "middle", l = !1, m = this.labelPosition, n = e.getBBox(), q = this.chart.rotate, p = a.isNegative;
                c -= n.height / 4 / 2;
            ...
            isNaN(k) && (k = .8);
            var m = this.useNegativeColorIfDown, n = this.width, q = this.height, p = this.y, t = this.rotate, r = this.columnCount, u = d.toCoordinate(this.cornerRadiusTop,
                k / 2), x = this.connect, y = [], w = [], z, A, B, C, D = this.chart.graphs.length, L, I = this.dx / this.tcc, S = this.dy / this.tcc, O = f.stackType, Q = this.start, ia = this.end, H = this.scrollbar, Z = "graph-column-";
            H && (Z = "scrollbar-graph-column-");
            var va = this.categoryAxis, ma = this.baseCoord, Oa = this.negativeBase, ea = this.columnIndex, ca = this.lineThickness, X = this.lineAlpha, ya = this.lineColorR, da = this.dashLength, fa = this.set, za, ga = this.getGradRotation(), T = this.chart.columnSpacing, Y = va.cellWidth, Ca = (Y * k - r) / r;
            T > Ca && (T = Ca);
            var G, v, na, ha = q, Pa =
                n, ba = 0, tb = 0, ub, vb, gb, hb, wb = this.fillColorsR, Qa = this.negativeFillColors, Ja = this.negativeLineColor, Ya = this.fillAlphas, Za = this.negativeFillAlphas;
            ...
            this.nmw = La(vb);
            d.isModern ||
            (this.nmy = this.nmx = 0, this.nmh = this.height);
            this.clustered || (r = 1);
            ...
            if ("line" == g || "step" == g || "smoothedLine" == g) {
                if (0 < Q) {
                    ...
                    if (this.fillColorsField)for (K = Q; -1 < K; K--)if (G =
                            e[K], v = G.axes[f.id].graphs[b], v.fillColors) {
            ...
            var Nb =
                this.noStepRisers, jb = -1E3, kb = -1E3, lb = this.minDistance, Sa = !0, $a = !1;
            for (K = Q; K <= ia; K++) {
                G = e[K];
                ...
                var R, P, J, aa, ja = NaN, E = NaN, F = NaN, N = NaN, M = NaN, pa = NaN, qa = NaN, ra = NaN, sa = NaN, wa = NaN, Da = NaN, ka = NaN, la = NaN, W = NaN, zb = NaN, Ab = NaN, ta = NaN, ua = void 0, Ma = wb, Va = Ya, Ha = ya, Aa, Ea, Bb = this.proCandlesticks, mb = this.topRadius, Fa = q - 1,
                    oa = n - 1, bb = this.pattern;
                ...
                if (Ia) {
                    ...
                    m && (void 0 == this.openField ? ab &&
                    (ab.isNegative = Ta < W ? !0 : !1, isNaN(Ta) && (v.isNegative = !Sa)) : v.isNegative = Ta > W ? !0 : !1);
                    ...
                    "start" == this.pointPosition && (ja -= Y / 2 + Math.floor(Wa * Y / 2),
                        xa = 0, Ga = Math.floor(Y) + Math.floor(Wa * Y));
                    ...
                    switch (g) {
                        ...
                        case "smoothedLine":
                            if (isNaN(W))x || (this.drawSmoothedGraph(y, w, U, V), y = [], w = [], U = [], V = []); else {
                                if (Math.abs(E -
                                        jb) >= lb || Math.abs(F - kb) >= lb)y.push(E), w.push(F), jb = E, kb = F;
                                wa = E;
                                Da = F;
                                ka = E;
                                la = F;
                            ...
                            if (!isNaN(W)) {
                                ...
                                if (!(W < Pb && ob < Pb || W > Qb && ob > Qb)) {
                                    ...
                                    if (t) {
                                        ...
                                        "3d" == O ? (R = E - (r / 2 - this.depthCount + 1) * (k + T) + T / 2 + I * ea, P = M + S * ea, Ba = ea) : (R = E - (r / 2 - ea) * (k + T) + T / 2, P = M, Ba =
                                            0);
                                        J = k;
                                        wa = R + k / 2;
                                        Da = F;
                                        ...
                                        J = d.roundTo(J, 2);
                                        aa = d.roundTo(aa, 2);
                                        R < n + ea * I && 0 < J && (this.showOnAxis && (P -= S / 2), ua = new d.Cuboid(h, J, aa, I - a.d3x, S - a.d3y, Ma, Va, ca, Aa, this.lineAlpha, ga, u, t, da, bb, mb, Z), v.columnHeight =
                                            Math.abs(aa), v.columnWidth = Math.abs(J))
                                    }
                                }
                                if (ua) {
                                    Ea = ua.set;
                                    ...
                                    if (!H) {
                                        ...
                                        "3d" == O && (t ? (L = (this.end + 1 - K) * D - c - 1E3 * this.depthCount, wa += I * this.columnIndex, ka += I * this.columnIndex, v.y += I * this.columnIndex) : (L = (D - c) * (K + 1) + 1E3 *
                                            this.depthCount, Da += S * this.columnIndex, la += S * this.columnIndex, v.y += S * this.columnIndex));
                            ...
                            if (!isNaN(ta) && !isNaN(W)) {
                                ...
                                if (t) {
                                    ...
                                    if (P < q && 0 < J) {
                                        ...
                                        aa = E - N;
                                        ua = new d.Cuboid(h, aa, J, I, S, Ma, Ya, ca, Aa, X, ga, u, t, da, bb,
                                            mb, Z)
                                    }
                                } else {
                                    "open" == l && (la = M);
                                    ...
                                    if (R < n && 0 < J) {
                                        Bb && W >= ta && (Va = 0);
                                        var ua = new d.Cuboid(h, J, aa, I, S, Ma, Va, ca, Aa, X, ga, u, t, da, bb, mb, Z), Fb, Gb;
                                        W > ta ? (Fb = [F, sa], Gb = [M, qa]) : (Fb = [M, sa], Gb = [F, qa]);
                                        !isNaN(sa) && !isNaN(qa) && E < n && 0 < E && (Xa = d.line(h,
                                            [E, E], Fb, Aa, X, ca), cb = d.line(h, [E, E], Gb, Aa, X, ca), d.setCN(a, Xa, this.bcn + "line-high"), v.className && d.setCN(a, Xa, v.className, !0), d.setCN(a, cb, this.bcn + "line-low"), v.className && d.setCN(a, cb, v.className, !0))
                                    }
                                }
                        ...
                        case "ohlc":
                            if (!(isNaN(ta) || isNaN(zb) || isNaN(Ab) ||
                                ...
                                if (t) {
                                    ...
                                    if (0 === E && 0 === N && 0 === pa && 0 === ra)continue;
                                    if (E == oa && N == oa && pa == oa && ra == oa)continue;
                                    var Hb = F - k / 2, Hb = d.fitToBounds(Hb, 0, q), Sb = d.fitToBounds(F, 0, q), Ib = F + k / 2, Ib = d.fitToBounds(Ib, 0, q);
                                    0 <= N && N <= oa && (qb = d.line(h, [N, N], [Hb, Sb], Ha, X, ca, da));
                                    0 < F && F < q && (pb = d.line(h, [pa, ra], [F, F], Ha, X, ca, da));
                                    0 <=
                                    E && E <= oa && (rb = d.line(h, [E, E], [Sb, Ib], Ha, X, ca, da))
                                } else {
                                    la = F;
                                    "open" == l && (la = M);
                                    "high" == l && (la = sa);
                                    "low" == l && (la = qa);
                                    var ka = E, qa = d.fitToBounds(qa, 0, Fa), sa = d.fitToBounds(sa, 0, Fa), Jb = E - k / 2, Jb = d.fitToBounds(Jb, 0, n), Tb = d.fitToBounds(E, 0, n), Kb = E + k / 2, Kb = d.fitToBounds(Kb, 0, n);
                        ...
                        if (this.end - this.start <= Ub || 0 === Ub) {
                            ...
                            if ("regular" == O || "100%" == O) {
                                ...
                                if (Yb) {
                                    ...
                                    if (Na) {
                                        var Zb = Na.getBBox(), $b = Zb.width, ac = Zb.height, db, eb, sb = f.totalTextOffset, bc = f.totals[K];
                                        bc && bc.remove();
                                        var fb = 0;
            ...
            var h = this;
            if (1 < a.length) {
                var f = h.noRounding, g = h.set, k = h.chart,
                    l = h.container, m = l.set(), n = l.set();
                g.push(n);
                g.push(m);
                ...
                var x = h.negativeLineColor, w = h.negativeFillColors, z = h.negativeFillAlphas, A = h.baseCoord;
            ...
            if (1 < a.length) {
                ...
                h.push(l);
                h.push(k);
                var m = this.lineAlpha, n = this.lineThickness,
                    h = this.dashLength, q = this.fillAlphas, p = this.lineColorR, t = this.fillColorsR, r = this.negativeLineColor, u = this.negativeFillColors, x = this.negativeFillAlphas, y = this.baseCoord, w = this.lineColorSwitched;
                w && (p = w);
                ...
                k.push(m.path);
                void 0 !== r && (n = new d.Bezier(g, a, b, r, z, n, t, 0, h, void 0, w), d.setCN(f, n, this.bcn + "stroke"), d.setCN(f, n, this.bcn +
                    "stroke-negative"), l.push(n.path));
                0 < q && (m = a.join(";").split(";"), p = b.join(";").split(";"), n = "", 0 < c.length ? (c.push("M"), e.push("M"), c.reverse(), e.reverse(), m = a.concat(c), p = b.concat(e)) : (this.rotate ? (n += " L" + y + "," + b[b.length - 1], n += " L" + y + "," + b[0]) : (n += " L" + a[a.length - 1] + "," + y, n += " L" + a[0] + "," + y), n += " L" + a[0] + "," + b[0]), c = new d.Bezier(g, m, p, NaN, 0, 0, t, q, h, n, w), d.setCN(f, c, this.bcn + "fill"), c.path.pattern(this.pattern, NaN, f.path), k.push(c.path), u || void 0 !== r) && (x || (x = q), u || (u = r), a = new d.Bezier(g, a, b, NaN,
                    0, 0, u, x, h, n, w), a.path.pattern(this.pattern, NaN, f.path), d.setCN(f, a, this.bcn + "fill"), d.setCN(f, a, this.bcn + "fill-negative"), l.push(a.path));
                this.applyMask(l, k)
            }
            ...
            var a =
                this.chart, b = this.set, c = this.bulletSet, e = this.x, d = this.y;
            b.show();
            c.show();
            ...
            b = b.startDuration;
            a && (this.rotate ? a.animateWidth(b,
                c) : a.animateHeight(b, c), a.set.show())
            ...
            if (!isNaN(b) && !isNaN(c) && ("none" != this.bullet || this.customBullet || a.bullet || a.customBullet)) {
                var e =
                    this.chart, h = this.container, f = this.bulletOffset, g = this.bulletSize;
                ...
                q = this.bulletColorR;
                a.lineColor && (this.bulletColorSwitched =
                    a.lineColor);
                ...
                if (p) {
                    p.size = g || 0;
                    if (e = this.bulletHitAreaSize)h = d.circle(h, e, "#FFFFFF", .001, 0), h.translate(b, c), a.hitBullet = h, this.bulletSet.push(h), this.addListeners(h,
                        a);
                    a.bulletGraphics = p
                } else p = {size: 0};
                p.graphDataItem = a;
            ...
            if (g && g.enabled && this.showBalloon && !this.hidden) {
                ...
                m && "" !== m ? (e = f.getBalloonColor(this, a), g.drop || (g.pointerOrientation = b), b = a.x, h = a.y, f.rotate && (b = a.y, h = a.x), b += k, h += l, isNaN(b) || isNaN(h) ? this.hideBalloonReal() : (a = this.width, q = this.height, n && g.setBounds(k, l, a + k, q + l), g.changeColor(e), g.setPosition(b,
                    h), g.fixPrevious(), g.fixedPosition && (c = !1), !c && "radar" != f.type && (b < k || b > a + k || h < l || h > q + l) ? (g.showBalloon(m), g.hide(0)) : (g.followCursor(c), g.showBalloon(m)))) : (this.hideBalloonReal(), this.resizeBullet(a, e, h))
...
(function () {
    ...
    d.ChartCursor = d.Class({
        construct: function (a) {
            ...
            this.zooming && this.fullWidth && this.selection && (this.rotate ? 0 < this.selection.height &&
            this.hhLine.hide() : 0 < this.selection.width && this.vvLine.hide())
            ...
            if (!this.pan && this.enabled) {
                ...
                isNaN(this.mouse2X) && 0 < Math.abs(h) && 0 < Math.abs(f) && (a = this.chart, b = d.rect(this.container,
                    h, f, this.cursorColor, this.selectionAlpha), d.setCN(a, b, "cursor-selection"), b.width = h, b.height = f, b.translate(c, e), this.set.push(b), this.selection = b);
                this.updateFullLine()
            }
            ...
            if (this.mouseIsDown) {
                var a = d.roundTo((this.mouseX - this.mouseX0) / this.width, 3), b = d.roundTo((this.mouseY - this.mouseY0) / this.height, 3), c = d.roundTo((this.mouse2X - this.mouse2X0) /
                    this.width, 3), e = d.roundTo((this.mouse2Y - this.mouse2Y0) / this.height, 2), h = !1;
            ...
            this.enabled && this.rolledOver && (this.leaveCursor || this.setIndex(void 0), this.forceShow = !1, this.hideCursor(),
                this.rolledOver = !1)
            ...
            if (c) {
                ...
                this.hhLine && this.hhLine.show()) : (this.hhLine && this.hhLine.hide(), this.vvLine && this.vvLine.show());
                this.updateFullLine();
                this.isHidden = !1;
            ...
            this.rotate ?
                (d = NaN, this.vvLine && this.vvLine.hide(), this.hhLine && e && (isNaN(a.fy) ? this.hhLine.translate(0, a.mouseY) : this.fixHLine(a.fy, 0))) : (f = NaN, this.hhLine && this.hhLine.hide(), this.vvLine && c && (isNaN(a.fx) ? this.vvLine.translate(a.mouseX, 0) : this.fixVLine(a.fx, 0)));
    ...
    d.ChartScrollbar = d.Class({
        inherits: d.SimpleChartScrollbar, construct: function (a) {
            ...
            if (a.enabled) {
                ...
                var b = a.chart, c = b.chartData, e = a.categoryAxis, h = a.rotate,
                    f = a.x, g = a.y, k = a.width, l = a.height, m = a.gridAxis, n = a.set;
                e.setOrientation(!h);
        ...
        construct: function (a) {
            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    ...
                    var r = this.horizontalPadding, u = this.verticalPadding, x = this.pointerWidth, y = this.pointerOrientation, w = this.cornerRadius,
                        z = c.fontFamily, A = this.fontSize;
                    ...
                    C < g && (C = g);
                    C + D > l && (C = l - D);
                    var k = A + u, m = C + r, O = this.shadowAlpha, Q = this.shadowColor, r = this.borderThickness, ia = this.bulletSize, H, u = this.fillAlpha, Z = this.borderAlpha;
                    this.showBullet && (H = d.circle(h, ia, t, u), f.push(H));
                    this.drop ? (g = D / 1.6, l = 0, "V" == y && (y = "down"), "H" == y && (y = "left"), "down" == y && (C = a + 1, A = b - g - g / 3), "up" == y && (l = 180, C = a + 1, A = b + g + g / 3), "left" == y && (l = 270, C = a + g + g / 3 + 2, A = b), "right" == y && (l = 90, C = a - g - g / 3 + 2, A = b), k = A - I / 2 + 1, m = C - L / 2 - 1, q = d.drop(h, g, l, q, u, r, p, Z)) : 0 < w || 0 === x ? (0 < O && (a = d.rect(h, D, z, q, 0, r + 1,
                        Q, O, w), d.isModern ? a.translate(1, 1) : a.translate(4, 4), f.push(a)), q = d.rect(h, D, z, q, u, r, p, Z, w)) : (t = [], w = [], "H" != y ? (g = a - C, g > D - x && (g = D - x), g < x && (g = x), t = [0, g - x, a - C, g + x, D, D, 0, 0], w = S ? [0, 0, b - A, 0, 0, z, z, 0] : [z, z, b - A, z, z, 0, 0, z]) : (y = b - A, y > z - x && (y = z - x), y < x && (y = x), w = [0, y - x, b - A, y + x, z, z, 0, 0], t = a < g + (l - g) / 2 ? [0, 0, C < a ? 0 : a - C, 0, 0, D, D, 0] : [D, D, C + D > a ? D : a - C, D, D, 0, 0, D]), 0 < O && (a = d.polygon(h, t, w, q, 0, r, Q, O), a.translate(1, 1), f.push(a)), q = d.polygon(h, t, w, q, u, r, p, Z));
                    this.bg = q;
                    f.push(q);
                    q.toFront();
                    ...
                    0 < this.animationDuration && !e && !isNaN(this.prevX) && (f.translate(this.prevX, this.prevY, NaN, !0), f.animate({translate: C - h + "," + A}, b, "easeOutSine"), n && (B.left = this.prevTX + "px", B.top = this.prevTY + "px", this.xAnim = c.animate({node: n}, "left", this.prevTX, m, b, "easeOutSine",
...
(function () {
    ...
    d.TrendLine = d.Class({
        construct: function (a) {
            ...
            var a = this;
            a.destroy();
            var b = a.chart, c = b.container, e, h, f, g, k = a.categoryAxis, l = a.initialDate, m = a.initialCategory, n = a.finalDate, q = a.finalCategory, p = a.valueAxis, t = a.valueAxisX, r = a.initialXValue, u = a.finalXValue, x = a.initialValue, y =
                a.finalValue, w = p.recalculateToPercents, z = b.dataDateFormat;
...
(function () {
    ...
    d.drop = function (a, b, c, d, h, f, g, k) {
        var l = 1 / 180 * Math.PI, m = c - 20, n = Math.sin(m * l) * b, q = Math.cos(m * l) * b, p = Math.sin((m + 40) * l) * b, t = Math.cos((m + 40) * l) * b, r = .8 * b, u = -b / 3, x = b / 3;
        0 === c && (u = -u, x = 0);
        180 == c && (x = 0);
        90 == c && (u = 0);
        270 == c && (u = 0, x = -x);
    ...
    d.wedge = function (a, b, c, e, h, f, g, k, l, m, n, q, p, t) {
        ...
        g = r(g);
        k = r(k);
        var u = r(g / f * k), x = d.VML, y = 359.5 + f / 100;
        359.94 < y && (y = 359.94);
        h >= y && (h = y);
        var w = 1 / 180 * Math.PI, y = b + Math.sin(e * w) * k, z = c - Math.cos(e * w) * u, A = b + Math.sin(e * w) * f, B = c - Math.cos(e * w) * g, C = b + Math.sin((e + h) * w) * f, D = c - Math.cos((e + h) * w) * g, L = b + Math.sin((e + h) * w) * k, w = c - Math.cos((e + h) * w) * u, I = {
        ...
        if (0 < l) {
            ...
            l = a.path(" M" + C + "," + D + " L" + C + "," + (D + l) + " L" + L + "," + (w + l) + " L" + L + "," + w + " L" + C + "," + D + " Z", void 0, void 0,
                "1000,1000").attr(I);
            e.push(Q);
            e.push(l)
        }
        ...
        a.handDrawn && (k = d.line(a, [y, A], [z, B], m.stroke, m.thickness * Math.random() * a.handDrawThickness, m["stroke-opacity"]),
            e.push(k));
    ...
    d.AmLegend = d.Class({
        construct: function (a) {
            ...
            var a = this.position, b = this.marginLeft + this.titleWidth, c = this.marginRight, e = this.marginTop,
                h = this.marginBottom, f = this.horizontalGap, g = this.div, k = this.divWidth, l = this.maxColumnsReal, m = this.verticalGap, n = this.spacing, q = k - c - b, p = 0, t = 0, r = this.container;
            this.set && this.set.remove();
            var u = r.set();
            this.set = u;
            var x = r.set();
            u.push(x);
            var y = this.entries, w, z;
            ...
            var A = t = 0, B = f, C = 0, D = 0;
            for (z = 0; z < y.length; z++) {
                var L = y[z];
                this.reversedOrder && (L = y[y.length - z - 1]);
                w = L.getBBox();
                var I;
                this.equalWidths ? I = A * (p + n + this.markerLabelGap) :
                    (I = B, B = B + w.width + f + n);
